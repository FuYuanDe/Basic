...
/*
char bfd_event_str[][100] = {
	"ontrol Detection Time Expired",            
	"Neighbor Signaled Session Dow",    	
	"Received_adminDown",
};
...
// BFD消息类型
enum MSGTYPE {
	HaBFDSessionCreateReq 		= 0,	// 创建请求
	HaBFDSessionCreateSuccRsp   = 1,	// 成功响应
	HaBFDSessionCreateFailRsp   = 2,	// 失败相应
	HaBFDSessionStateErrRsp		= 3	// 会话异常
};
